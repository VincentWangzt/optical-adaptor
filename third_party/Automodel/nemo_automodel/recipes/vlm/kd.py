...
from nemo_automodel.recipes.vlm.finetune import FinetuneRecipeForVLM, _move_to_device, build_model, calculate_loss
...
class KnowledgeDistillationRecipeForVLM(FinetuneRecipeForVLM):
    ...
    def _get_separate_teacher_logits(self, batch: dict[str, Any]) -> torch.Tensor:
        ...
        Returns:
            ...
            full teacher logits.
        """
        batch = {**batch.get("teacher", batch), "labels": batch["labels"]}
    ...
    def _forward_backward_step(
        ...
        *,
        ...
        batch = {**batch.get("student", batch), "labels": batch["labels"]}
        batch = {
            k: (
        ...
        with sync_ctx, train_ctx():
            ...
            with self._stage_timer("student_forward"):
            ...
            if is_train:
                with self._stage_timer("student_backward"):
    ...
    def _run_train_optim_step(self, batches, max_grad_norm: float | None = None):
        ...
        with self._stage_timer("optimizer"):
