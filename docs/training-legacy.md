# Historical cached training pipeline

This document describes the retired Accelerate training pipeline and existing
cache artifacts. Its training launchers and console commands have been removed.
Use [training.md](training.md) and `configs/automodel.yaml` for new experiments.
